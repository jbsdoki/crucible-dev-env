...
##########################################################################################################*/
export const elementsByCategory: Record<string, number[]> = {
...
export const getElementCategory = (atomicNumber: number): string => {
...
##########################################################################################################*/
export const elementGridPosition: Record<number, { row: number; col: number }> = {
    1: { row: 1, col: 1 },
    2: { row: 1, col: 18 },
